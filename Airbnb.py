...
st.set_page_config(page_title= "Airbnb Data Visualization | By Srinivasan M",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Srinivasan M*!
                                        Data has been gathered from Mongodb Atlas"""})

# Creating Option Menu in the side bar
with st.sidebar:
    selected = option_menu("Menu", ["Home","Overview","Explore", "Tableau Dashboard"], 
...
if selected == "Home":
    ...
    col1.markdown("## :blue[Technologies used] : Python Scripting, Data Preprocessing, Visualization, EDA, Streamlit, MongoDb, Tableau")
...
# TABLEAU DASHBOARD
if selected == "Tableau Dashboard":
    image ='Airbnb Analysis.png'
